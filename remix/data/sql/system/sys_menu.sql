...
INSERT INTO sys_menu (menu_id, parent_id, menu_name, menu_type, route_path, component, icon, order_no, visible, status,
                      create_time, del_flag)
VALUES (1, NULL, '学习进度', 1, NULL, NULL, 'DataLine', 1, 1, 1, NOW(), 0),
       ...
       (41, 4, '用户列表', 2, '/system/user', '/system/user/index', NULL, 1, 1, 1, NOW(), 0),
